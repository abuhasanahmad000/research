...
export default function App() {
  ...
  const [searchParams, setSearchParams] = useState({
    filtersEnabled: false,  // master toggle
    yearFrom: 2019,
    yearTo: 2025,
    databases: [],          // empty = all
    qIndex: [],             // empty = all
  ...
  // Filtered articles — derived from rawArticles + searchParams when filters enabled
  const filteredArticles = searchParams.filtersEnabled
    ? applyFilters(rawArticles, searchParams)
    : rawArticles;
...
["keyword1","keyword2","keyword3"]`,
  ...
  async function runSearch() {
    ...
    // Reset filter state — start clean: no filters applied
    setSearchParams(p => ({ ...p, filtersEnabled: false }));
...
// ═══════════════════════════════════════════════
function TabSearch({ theme, setTheme, keywords, setKeywords, kwInput, setKwInput, searchParams, setSearchParams, rawArticles, filteredArticles, searchDone, searchTotalCount, aiStatus, suggestKeywords, runSearch, downloadCSV, setTab }) {
